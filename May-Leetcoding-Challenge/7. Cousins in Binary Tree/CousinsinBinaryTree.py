...
class Solution:
    def isCousins(self, root: TreeNode, x: int, y: int) -> bool:
        # same depth, different parents -> true
        #So while traversing, we need to keep track of depth and parent.
        xinfo = []
        yinfo = []
        depth = 0
        parent = None
        ...
        self.dfs(root, x, y, 0, None, xinfo, yinfo) #initially depth=0,parent is None
